...
\DIFaddbegin \DIFadd{the GUI is provided by the Dash Library in Visualization module, so we don't need an independent GUI module
}
...
Live Neuro provides a user interface with features\DIFdelbegin \DIFdel{such as}\DIFdelend :

\begin{itemize}
    \DIFaddbegin \item \DIFadd{Data loading from disk
    }\item \DIFadd{Data preprocessing and filtering
}\DIFaddend \item Data plotting of MEG/EEG data
