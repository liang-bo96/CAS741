...
\DIFaddend \begin{itemize}
  \item \DIFdelbegin \DIFdel{\_updateLinkedAxes(}\DIFdelend \DIFaddbegin \texttt{\DIFadd{plot(data: List<R}[]\DIFadd{>}}\DIFadd{, }\texttt{\DIFadd{plotTypes: List<String>}}\DIFadd{, }\texttt{\DIFadd{interactionMode: String}}\DIFaddend )
